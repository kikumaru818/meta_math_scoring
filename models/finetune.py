...
class BaseModel(nn.Module):
    ...
    def prepare_data(self):
        if self.params.task!='all':
            data = load_dataset(self.params.task, create_hash=False,train=0.6, valid=0.2,fold=self.params.fold,spell_check=self.params.spell_check)
            ...
            data = [load_dataset(task, create_hash=False,train=0.6, valid=0.2,fold=self.params.fold,spell_check=self.params.spell_check) for task in self.params.task_lists]
